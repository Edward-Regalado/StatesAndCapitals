...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        StateInfo cardinalState = states.stream().filter(stateInfo -> stateInfo.getStateBird().equals("cardinal")).findAny().orElseThrow(null);
        ...
        Double averageYearlyPrecipitationAcrossStateCapitals = states.stream().collect(averagingDouble(stateInfo -> stateInfo.getCapital().getAverageYearlyPrecipitationInInches()));
